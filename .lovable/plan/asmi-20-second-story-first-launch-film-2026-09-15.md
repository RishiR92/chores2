...
**Style:** kinetic editorial comedy. High-energy typography, physical receipts, stamped statuses, and one continuous visual transformation from request to result.

**Palette:** preserve Asmi’s paper, ink, coral, blue, citrus, and mint palette, but use large color fields and sharp contrast instead of recreating website sections.

**Typography:** bold grotesque for the story and statuses; italic serif only for the Asmi wordmark; monospace reserved for timestamps and proof.
...
- **Entrance:** messages and proof fragments snap in with directional momentum and slight overshoot.
- **Progression:** the camera follows the coral chase line through one connected world, avoiding slide-by-slide cuts.
- **Accent motion:** failed attempts compress or get stamped; successful action expands and locks into place.
- **Exit:** every loose element gets pulled into the final receipt, then the Asmi wordmark.
- Use varied pacing: fast 5-10 frame accents, readable 20-35 frame holds, and one longer payoff beat.
- Compose vertical and widescreen independently so neither feels cropped.
