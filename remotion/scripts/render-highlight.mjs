...
const ids = process.env.COMP ? [process.env.COMP] : ["aiToAiV7Widescreen","aiToAiV7Vertical"];
const stems = {highlightV11Vertical:"asmi-story-v11-vertical",highlightV11Widescreen:"asmi-story-v11-widescreen",chaseEngineVertical:"asmi-chase-engine-vertical",chaseEngineWidescreen:"asmi-chase-engine-widescreen",aiToAiWidescreen:"asmi-ai-to-ai-widescreen",aiToAiVertical:"asmi-ai-to-ai-vertical",aiToAiV2Widescreen:"asmi-ai-to-ai-v2-widescreen",aiToAiV2Vertical:"asmi-ai-to-ai-v2-vertical",aiToAiV3Widescreen:"asmi-ai-to-ai-v3-widescreen",aiToAiV3Vertical:"asmi-ai-to-ai-v3-vertical",aiToAiV4Widescreen:"asmi-ai-to-ai-v4-widescreen",aiToAiV4Vertical:"asmi-ai-to-ai-v4-vertical",aiToAiV5Widescreen:"asmi-ai-to-ai-v5-widescreen",aiToAiV5Vertical:"asmi-ai-to-ai-v5-vertical",aiToAiV6Widescreen:"asmi-ai-to-ai-v6-widescreen",aiToAiV6Vertical:"asmi-ai-to-ai-v6-vertical",aiToAiV7Widescreen:"asmi-ai-to-ai-v7-widescreen",aiToAiV7Vertical:"asmi-ai-to-ai-v7-vertical"};

for (const id of ids) {
  const composition=await selectComposition({serveUrl:bundled,id,puppeteerInstance:browser});
  if(process.env.STILLS === "1") {
    for(const frame of [20,70,125,160,250,420,480,500,550,650,720,800,870,930,1000,1060,1120,1160]) await renderStill({composition,serveUrl:bundled,output:`/tmp/${id}-review-${frame}.png`,frame,puppeteerInstance:browser});
    continue;
  }
