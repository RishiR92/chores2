...
const ids = process.env.COMP ? [process.env.COMP] : ["wineFranceV3Widescreen","wineFranceV3Vertical"];
const stems = {highlightV11Vertical:"asmi-story-v11-vertical",highlightV11Widescreen:"asmi-story-v11-widescreen",chaseEngineVertical:"asmi-chase-engine-vertical",chaseEngineWidescreen:"asmi-chase-engine-widescreen",aiToAiWidescreen:"asmi-ai-to-ai-widescreen",aiToAiVertical:"asmi-ai-to-ai-vertical",aiToAiV2Widescreen:"asmi-ai-to-ai-v2-widescreen",aiToAiV2Vertical:"asmi-ai-to-ai-v2-vertical",aiToAiV3Widescreen:"asmi-ai-to-ai-v3-widescreen",aiToAiV3Vertical:"asmi-ai-to-ai-v3-vertical",aiToAiV4Widescreen:"asmi-ai-to-ai-v4-widescreen",aiToAiV4Vertical:"asmi-ai-to-ai-v4-vertical",aiToAiV5Widescreen:"asmi-ai-to-ai-v5-widescreen",aiToAiV5Vertical:"asmi-ai-to-ai-v5-vertical",aiToAiV6Widescreen:"asmi-ai-to-ai-v6-widescreen",aiToAiV6Vertical:"asmi-ai-to-ai-v6-vertical",aiToAiV7Widescreen:"asmi-ai-to-ai-v7-widescreen",aiToAiV7Vertical:"asmi-ai-to-ai-v7-vertical",wineFranceWidescreen:"asmi-wine-france-widescreen",wineFranceVertical:"asmi-wine-france-vertical",wineFranceV2Widescreen:"asmi-wine-france-v2-widescreen",wineFranceV2Vertical:"asmi-wine-france-v2-vertical",wineFranceV3Widescreen:"asmi-wine-france-v3-widescreen",wineFranceV3Vertical:"asmi-wine-france-v3-vertical"};

for (const id of ids) {
  const composition=await selectComposition({serveUrl:bundled,id,puppeteerInstance:browser});
  if(process.env.STILLS === "1") {
    for(const frame of [25,90,120,165,205,240,270,320,380,420,470,530,580,650,700,745,780,805]) await renderStill({composition,serveUrl:bundled,output:`/tmp/${id}-review-${frame}.png`,frame,puppeteerInstance:browser});
    continue;
  }
